...
rust_code = r'''//! Spatial Transaction Module for CoreTexDB
//!
...
with open(r"G:\cerebros\CoretexDB\src\coretex_spatial_transaction\mod.rs", "w", encoding="utf-8") as f:
    f.write(rust_code)
print("Written successfully - {} bytes", len(rust_code))
